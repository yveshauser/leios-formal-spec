...
-- Tactic.Derive.Convertible.liftTC
d_liftTC_12 ::
                               ...
                               then coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ...
                                            (coe
                                               (MAlonzo.RTE.QName
                                                  (18 :: Integer) (12560787650590174360 :: Integer)
                                                  "Class.Convertible.Convertible.to"
                                                  (MAlonzo.RTE.Fixity
                                                     MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                            (coe
                                               (MAlonzo.RTE.QName
                                                  (26 :: Integer) (12560787650590174360 :: Integer)
      ...
      (\ v1 ->
         case coe v1 of
           MAlonzo.Code.Agda.Builtin.Reflection.C_def_184 v2 v3
             -> case coe v2 of
                  MAlonzo.RTE.QName 8 12560787650590174360 _ _
                    -> case coe v3 of
                         (:) v4 v5
                           -> case coe v4 of
                                MAlonzo.Code.Agda.Builtin.Reflection.C_arg_98 v6 v7
...
d_autoConvert_240 v0 v1
  = coe
      ...
      (coe
         ...
         MAlonzo.Code.Tactic.Derive.HsType.d_'96'Set_12)
      (\ v2 ->
         coe
           MAlonzo.Code.Class.Monad.Core.du__'62''62'__20
           (coe MAlonzo.Code.Class.Monad.Instances.d_Monad'45'TC_6) (coe ())
           ...
           (coe
              ...
              (coe
                 ...
                 (coe
                    (MAlonzo.RTE.QName
                       (8 :: Integer) (12560787650590174360 :: Integer)
                       "Class.Convertible.Convertible"
           ...
           (coe
              MAlonzo.Code.Agda.Builtin.Reflection.d_bindTC_336 () () erased
              erased
              (MAlonzo.Code.Tactic.Derive.HsType.d_solveHsType_138
                 (coe
                    MAlonzo.Code.Agda.Builtin.Reflection.C_def_184 (coe v0)
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))
              (\ v3 ->
...
d_Test_250 = ()
data T_Test_250
  = C_Test'46'constructor_44505 Integer (Maybe Integer) [Integer]
-- Tactic.Derive.Convertible.Test.f
d_f_258 :: T_Test_250 -> Integer
d_f_258 v0
  = case coe v0 of
      C_Test'46'constructor_44505 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Tactic.Derive.Convertible.Test.g
d_g_260 :: T_Test_250 -> Maybe Integer
d_g_260 v0
  = case coe v0 of
      C_Test'46'constructor_44505 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Tactic.Derive.Convertible.Test.h
d_h_262 :: T_Test_250 -> [Integer]
d_h_262 v0
  = case coe v0 of
      C_Test'46'constructor_44505 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Tactic.Derive.Convertible.Test
d_Test_44567 = ()
type T_Test_44567 = Test
pattern C_MkTest_44569 a0 a1 a2 = MkTest a0 a1 a2
check_MkTest_44569 ::
  Integer ->
  MAlonzo.Code.Agda.Builtin.Maybe.T_Maybe_10 () Integer ->
  MAlonzo.Code.Agda.Builtin.List.T_List_10 () Integer -> T_Test_44567
check_MkTest_44569 = MkTest
cover_Test_44567 :: Test -> ()
cover_Test_44567 x
  = case x of
      MkTest _ _ _ -> ()
