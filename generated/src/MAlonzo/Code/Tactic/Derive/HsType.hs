  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               (MAlonzo.RTE.QName
                  (24 :: Integer) (7549178118818134215 :: Integer)
                 ...
                 coe
                   (case coe v2 of
                      MAlonzo.Code.Agda.Builtin.Reflection.C_def_184 v4 v5
                        -> case coe v4 of
                             MAlonzo.RTE.QName 24 7549178118818134215 _ _
                               -> coe
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               (MAlonzo.RTE.QName
                  (14 :: Integer) (7549178118818134215 :: Integer)
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            (MAlonzo.RTE.QName
                                               (20 :: Integer) (7549178118818134215 :: Integer)
...
d__'8614'__484 v0 v1
  = coe
      ...
      (coe
         ...
         (coe
            (MAlonzo.RTE.QName
               (70 :: Integer) (15422988094639456485 :: Integer)
               "Tactic.Derive.HsType.customName"
               (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
         (coe
            MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
